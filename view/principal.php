<div class="container">
    ...
    <section class="gridContainer">
      ...
      <?php  
        ...
        $listarCuriosidades = listarCuriosidades();
        foreach($listarCuriosidades as $curiosidade):
        ?>
        <a class="pag-link" <?=constant('URL_LOCAL_SITE_PAGINA').$curiosidade['curiosidade']?>">
          <div class="categoryCard">
          <p class="mainCategoryCardTitle"><?=$curiosidade['titulo']?></p> 
          <p class="mainCategoryCardDescription"><?= reduzirStr($curiosidade['curiosidade'],180)?></p>
          </div>
        </a>
        <?php endforeach?>
      </div>
