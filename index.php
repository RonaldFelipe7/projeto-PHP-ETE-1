...
$curiosidade = ($_SERVER["REQUEST_METHOD"] == "POST"
&& !empty($_POST['curiosidade'])) ? $_POST['curiosidade'] : null;


$titulodacuriosidade = ($_SERVER["REQUEST_METHOD"] == "POST"
&& !empty($_POST['titulo'])) ? $_POST['titulo'] : null;
...
}elseif($paginaUrl === "curiosidade"){ 
  cadastrarCuriosidade($titulo,$curiosidade);
...
include_once("view/header.php");
  if($paginaUrl === "principal"){
    ...
    include_once("view/curiosidade.php");  
  }elseif($paginaUrl === "contato"){
